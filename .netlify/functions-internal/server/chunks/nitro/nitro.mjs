...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "cf59be4b-f72f-4467-9988-c5190753345a",
...
const _lazy_lFEeTp = () => import('../build/renderer.mjs');

const handlers = [
  { route: '/api/form', handler: _lazy_VWpjI2, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_lFEeTp, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_lFEeTp, lazy: true, middleware: false, method: undefined }
];
